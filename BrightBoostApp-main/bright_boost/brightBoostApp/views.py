...
import random  # Import random module to generate random data

  # Import random module to generate random data
...
def weekly_attendance(request):
    ...
    for student_id in range(1, 21):
        ...
        present_days = random.randint(0, 7)
    ...
    return render(request, 'weekly_attendance.html', {'students_data': students_data})
