"""
Django settings for bright_boost project.
...
SECRET_KEY = 'django-insecure-x3$mgf7dw8o*+1sm8pf8j#%r4oep5*-jvx4!#d1o&ybyd0d8z2'
...
ROOT_URLCONF = 'bright_boost.urls'
...
WSGI_APPLICATION = 'bright_boost.wsgi.application'
